...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "commonmenu_admin", Texture = "gradient_bgd", Y = 10, Width = 415 },
        Navigation = {
            Rectangle = { Width = 0, Height = 0 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu_admin", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 0, Height = 0 },
        },
        Description = {
            Bar = { Y = 4, Width = 415, Height = 4 },
            Background = { Dictionary = "commonmenu_admin", Texture = "gradient_bgd", Y = 4, Width = 415, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.25 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu_admin", Texture = "gradient_bgd", Y = 4, Width = 415, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu_admin", Texture = "gradient_bgd", Y = 4, Width = 415, Height = 76 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if CurrentMenu.Sprite.Dictionary == "commonmenu_admin" then
...
function RageUI.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            RenderRectangle(CurrentMenu.X, 137 + CurrentMenu.Y + RageUI.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUI.ItemOffset - 125, 22, 22, 22, 100)
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 22, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight - 5, 22, 22, 22, 100)
                        
            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 20, 0, Description.Text.Scale, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
